...
with st.sidebar:
    ...
    # API Key
    # ── API Key: Streamlit Cloud secrets > env var > manual input ───────────
    ...
    auto_key = api_key_from_secrets or api_key_env
    ...
    if auto_key:
        ...
        api_key_input = st.text_input(
            ...
            type="password",
            help="Paste your Groq key, or add GROQ_API_KEY to Streamlit secrets.",
        )
        if api_key_input:
